...
void inputs_sys_init();
void inputs_sys_shutdown();
void input_update(f64 delta_time);

// keyboard input
DLL_EXPORT bool input_is_key_down(keys key);
DLL_EXPORT bool input_is_key_up(keys key);
DLL_EXPORT bool input_was_key_down(keys key);
DLL_EXPORT bool input_was_key_up(keys key);

void input_process_key(keys key, bool pressed);

// mouse input
DLL_EXPORT bool input_is_button_down(buttons button);
DLL_EXPORT bool input_is_button_up(buttons button);
DLL_EXPORT bool input_was_button_down(buttons button);
DLL_EXPORT bool input_was_button_up(buttons button);
DLL_EXPORT void input_get_mouse_position(s32* x, s32* y);
DLL_EXPORT void input_get_previous_mouse_position(s32* x, s32* y);
